...
namespace Do_An_Quan_Ly_Kho.XuatKho
{
    public partial class frmXuatKho : Form
    {
        ...
        public frmXuatKho(string ma)
        {
            ...
            cHUNG_TU_CHI_TIETTableAdapter.Fill(dsXuatKho.CHUNG_TU_CHI_TIET, txtMaChungTu.Text);
        }
        ...
        private void bbiTaoMoi_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            txtMaChungTu.Text = SqlHelper.GenCode("CHUNG_TU", "Ma_Chung_Tu", "XK", 1);
            txtMaHoaDon.Text = "";
            ...
            dsXuatKho.CHUNG_TU_CHI_TIET.Rows.Clear();
        }
        ...
        bool Kiem_Tra()
        {
            ...
            if (dsXuatKho.CHUNG_TU_CHI_TIET.Rows.Count == 0)
            {
