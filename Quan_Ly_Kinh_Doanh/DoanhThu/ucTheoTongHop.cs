...
{
    public partial class ucTheoTongHop : UserControl
    {
        ...
        private void bbiXem_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            dsDoanhThu.Tong_Hop_Theo_Ngay.Rows.Clear();
            dsDoanhThu.Tong_Hop_Theo_Ngay.Merge(sqlHelper.ExecuteDataTable(truy_van_sql, myPara, myValue));
