    ...
    public partial class ucTheoHangHoa : UserControl
    {
        ...
        private void bbiXem_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            @"
                ...
                SELECT Theo_Hang_Hoa.Ma_Hang_Hoa,
                       hh.Ten_Hang,
                       hh.Don_Vi,
                       hh.Nhom_Hang,
                       nh.Ten_Nhom_Hang,
                       Theo_Hang_Hoa.So_Luong_Nhap,
                       Theo_Hang_Hoa.Thanh_Tien_Nhap,
                       Theo_Hang_Hoa.So_Luong_Xuat,
                       Theo_Hang_Hoa.Thanh_Tien_Xuat
                FROM   (
                       ...
                       LEFT OUTER JOIN HANG_HOA hh
                            ON  Theo_Hang_Hoa.Ma_Hang_Hoa = hh.Ma_Hang
                       LEFT OUTER JOIN NHOM_HANG nh
                            ON  nh.Ma_Nhom_Hang = hh.Nhom_Hang
                WHERE  Theo_Hang_Hoa.So_Luong_Nhap != 0
                       OR Theo_Hang_Hoa.So_Luong_Xuat != 0
            ";
            ...
            dsDoanhThu.Theo_Hang_Hoa_Theo_Ngay.Rows.Clear();
            dsDoanhThu.Theo_Hang_Hoa_Theo_Ngay.Merge(sqlHelper.ExecuteDataTable(truy_van_sql, myPara, myValue));
